...
<Project Type="Project" LVVersion="21008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="tests" Type="Folder">
			<Item Name="labview-icon-editor-tests.lvlib" Type="Library" URL="../../tests/labview-icon-editor-tests.lvlib"/>
		</Item>
		...
		<Item Name="Tooling" Type="Folder">
			<Item Name="support" Type="Folder">
				<Item Name="test" Type="Folder">
					<Item Name="coverage.vi" Type="VI" URL="../../Tooling/support/test/coverage.vi"/>
					<Item Name="Get Todo Bookmarks.vi" Type="VI" URL="../../Tooling/support/test/Get Todo Bookmarks.vi"/>
					<Item Name="List VIs without Test Coverage.vi" Type="VI" URL="../../Tooling/support/test/List VIs without Test Coverage.vi"/>
					<Item Name="Pre-Build VI - Run Unit Tests.vi" Type="VI" URL="../../Tooling/support/test/Pre-Build VI - Run Unit Tests.vi"/>
				</Item>
			...
			<Item Name="test.vi" Type="VI" URL="../../Tooling/test.vi"/>
			<Item Name="Save all VIs in Folder.vi" Type="VI" URL="../../Tooling/Save all VIs in Folder.vi"/>
		</Item>
